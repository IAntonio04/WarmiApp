...
<div class="container mt-5">
    ...
    <a href="/descargar-documento-perinatal/{{$paciente->nombres}} {{ $paciente->apellidos }}" class="btn btn-info" download><i class="fa-solid fa-download"></i> HC Perinatal</a>
    @endforeach
    <hr>
    ...
    <div class="container mt-4"  style="overflow-y: auto; max-height: 60vh" >
        ...
        <div class="col-md-12 mt-4">
            ...
            <ul class="list-group" style="overflow-y: auto; max-height: 200px">
                @forelse ($historiasClinicas as $hcs)
                    <li class="list-group-item">
                        <strong>{{ $hcs->titulo }} : </strong>{{ \Illuminate\Support\Str::limit($hcs->diagnostico, 50, '...') }},
                        {{ \Carbon\Carbon::parse($hcs->created_at)->locale('es_ES')->isoFormat('LL') }}
                        <a href="/descargar-documento-paciente/{{$hcs->archivo_adjunto_path}}" class="btn" download><i class="fa-solid fa-download"></i></a>
                    </li>
                @empty
                    <li class="list-group-item">No hay contenido disponible.</li>
                @endforelse
    ...
    <div class="col-md-7">
        ...
        <div class="col-md-12 mt-4">
            ...
            <embed src="{{Storage::disk('s3')->url('hc_pacientes/'.$hc->archivo_adjunto_path) }}" id="visorPDF" type="application/pdf" width="100%" height="600" readonly>
        </div>
    </div>
</div>
